from machine_learning.development.optimized_lstm import hyperparameter_tunning as hpt
...
file.write(bytes("time_steps: %d, " %(optimal_time_steps), 'UTF-8'))
...
epochs_result = hpt.optimal_epochs(stock, start_date, end_date, future_gap, time_steps, split, dropout, 
...
print("Time Steps:", optimal_time_steps)
